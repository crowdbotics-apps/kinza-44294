"""
Django settings for kinza_44294 project.
...
WSGI_APPLICATION = 'kinza_44294.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kinza_44294 API",
    "DESCRIPTION": "API documentation for kinza_44294 App",
    "VERSION": "v1",
}
